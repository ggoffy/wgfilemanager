...
/**
 * Module:  Wgfilemanager
 *
 * @package      \module\Wgfilemanager\class
...
class Utility
{
    ...
    {
        /** @var Wgfilemanager\Helper $helper */
        if (null === $options) {
            $options           = [];
            $options['name']   = 'Editor';
