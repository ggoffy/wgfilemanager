        ...
        <tbody>
            ...
            <tr class='<{cycle values='odd, even'}>'>
                ...
                <td class="center  width5">
                    <a href="directory.php?op=edit&amp;id=<{$directory.id|default:false}>&amp;start=<{$start|default:0}>&amp;limit=<{$limit|default:0}>" title="<{$smarty.const._EDIT}>"><img src="<{xoModuleIcons16 'edit.png'}>" alt="<{$smarty.const._EDIT}> directory" ></a>
                    <a href="directory.php?op=clone&amp;id_source=<{$directory.id|default:false}>" title="<{$smarty.const._CLONE}>"><img src="<{xoModuleIcons16 'editcopy.png'}>" alt="<{$smarty.const._CLONE}> directory" ></a>
                    <a href="directory.php?op=delete&amp;id=<{$directory.id|default:false}>" title="<{$smarty.const._DELETE}>"><img src="<{xoModuleIcons16 'delete.png'}>" alt="<{$smarty.const._DELETE}> directory" ></a>
                </td>
            </tr>
            <{/foreach}>
        </tbody>
