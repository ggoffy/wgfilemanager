                ...
                <div class="col-xs-12 wgf-filepanel-right-header">
                    ...
                    <div class="col-xs-12 col-md-6 wgf-folderaction right">
                        <{if $permUpload|default:false}>
                            <a href='file.php?op=new&amp;dir_id=<{$dirId|default:0}>' title='<{$smarty.const._MA_WGFILEMANAGER_FILE_UPLOAD}>'><img src="<{$wgfilemanager_icon_bi_url}>upload.svg" alt="<{$smarty.const._MA_WGFILEMANAGER_INDEX_STYLEGROUPED}>" ></a>
                        <{/if}>
                    </div>
                </div>
            </div>
