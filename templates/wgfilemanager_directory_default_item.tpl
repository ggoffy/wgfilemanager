<tr>
    ...
    <td class=''>
        ...
        <{if $permEdit|default:false}>
            <a class='btn btn-success wgf-directory-list-btn' href='directory.php?op=new&amp;parent_id=<{$directory.id|default:false}>' title='<{$smarty.const._MA_WGFILEMANAGER_DIRECTORY_ADD}>'><{$smarty.const._MA_WGFILEMANAGER_DIRECTORY_ADD}></a>
