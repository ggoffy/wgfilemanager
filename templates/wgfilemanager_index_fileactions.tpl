<div class="btn-group btn-group-sm" role="group" aria-label="group_view">
    ...
    <{if $showBtnDetails|default:false}>
        <a class='btn btn-sm btn-outline-primary' href='file.php?op=show&amp;id=<{$file.id}><{$params|default:''}>' title='<{$smarty.const._MA_WGFILEMANAGER_DETAILS}>'><img src="<{$wgfilemanager_icon_bi_url}>arrow-right.svg" alt="<{$smarty.const._MA_WGFILEMANAGER_DETAILS}>" ></a>
    <{/if}>
</div>
...
<{if $permEditFile|default:false || $showBtnBack|default:false}>
    <div class="btn-group btn-group-sm" role="group" aria-label="group_view">
        <{if $permEditFile|default:false}>
            <a class="btn btn-sm btn-outline-primary" href='file.php?op=edit&amp;id=<{$file.id}><{$params|default:''}>' title='<{$smarty.const._EDIT}>'><img src="<{$wgfilemanager_icon_bi_url}>pencil-square.svg" alt="<{$smarty.const._EDIT}>" ></a>
            <a class="btn btn-sm btn-outline-danger" href='file.php?op=delete&amp;id=<{$file.id}><{$params|default:''}>' title='<{$smarty.const._DELETE}>'><img src="<{$wgfilemanager_icon_bi_url}>trash.svg" alt="<{$smarty.const._DELETE}>" ></a>
        <{/if}>
