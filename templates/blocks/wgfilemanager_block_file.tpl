<table class='table table-<{$table_type|default:false}>'>
    <thead>
        <tr class='head'>
            ...
            <th class='center'><{$smarty.const._MB_WGFILEMANAGER_FILE_DESCRIPTION}></th>
        </tr>
    </thead>
    ...
    <tbody>
        ...
        <tr class='<{cycle values="odd, even"}>'>
            ...
            <td class='center'><{$file.directory_id|default:false}></td>
            <td class='center'><{$file.name|default:false}></td>
            <td class='center'><{$file.description_short|default:false}></td>
            <td class='center'><a href='file.php?op=show&amp;id=<{$file.id|default:false}>' title='<{$smarty.const._MB_WGFILEMANAGER_FILE_GOTO}>'><{$smarty.const._MB_WGFILEMANAGER_FILE_GOTO}></a></td>
        </tr>
        <{/foreach}>
    </tbody>
    <{/if}>
