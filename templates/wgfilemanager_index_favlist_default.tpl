            ...
            <ul style="list-style-type: none;padding:0 0;">
                <{foreach item=favdir from=$fav_list.dirs name=favdir}>
                    <li class="wgf-favlist d-flex mb-2 nav-link">
                        <div class="p-2"><a class='wgf-favlist-link' href='<{$wgfilemanager_url}>/index.php?op=list&amp;dir_id=<{$favdir.id}>' title='<{$favdir.name}>'><i class="bi-folder"></i>
                                <{$favdir.name|truncate:$lengthName:"...":true}></a></div>
                ...
                <{foreach item=favfile from=$fav_list.files name=favfile}>
                    <li class="wgf-favlist d-flex mb-2 nav-link">
                        <div class="p-2"><a class='wgf-favlist-link' href='<{$wgfilemanager_url}>/file.php?op=show&file_id=<{$favfile.id}>&dir_id=<{$favfile.directory_id}>' title='<{$favfile.name}>'><i class="bi-file-earmark"></i>
                                <{$favfile.name|truncate:$lengthName:"...":true}></a></div>
