 ...
 */
function xoops_module_pre_uninstall_wgfilemanager(\XoopsModule $module)
{
 ...
 */
function xoops_module_uninstall_wgfilemanager(\XoopsModule $module)
{
    ...
    if (is_file($xmlfile)) {
        if (false === ($delOk = \unlink($xmlfile))) {
            $module->setErrors(\sprintf(\_AM_WGFILEMANAGER_ERROR_BAD_REMOVE, $xmlfile));
        }
    }
